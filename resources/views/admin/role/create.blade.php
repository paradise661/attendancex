...
@section('content')
    <div class="xl:col-span-6 col-span-12 mt-4">
        <div class="box">
            ...
            <div class="box-body">
                <form class="grid grid-cols-12 gap-4 mt-0" action="{{ route('roles.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="p-4 bg-gray-50">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-2">
                                    @foreach ($permissions as $key => $permission)
                                        <div
                                            class="bg-white p-5 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow duration-200">
                                            <!-- Section Title -->
                                                ...
                                                @foreach ($permission as $item)
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        <label class="text-gray-700 text-sm"
                                                            for="permission[]">{{ ucwords($item->name) }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    @error('permission')
                                        <div
                                            class="text-sm text-red-600 mt-6 col-span-1 sm:col-span-2 lg:col-span-3 xl:col-span-4">

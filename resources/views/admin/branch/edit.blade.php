            ...
            <div class="box-body">
                <form class="grid grid-cols-12 gap-4 mt-0" action="{{ route('branches.update', $branch->id) }}"
                    ...
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <div class="relative">
                            <input
                                ...
                                type="number" aria-label="Radius" name="radius"
                                value="{{ old('radius', $branch->radius) }}" min="1">
                            @error('radius')
                                <div class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                                    <svg class="h-5 w-5 text-danger" width="16" height="16" fill="currentColor"
                                        viewBox="0 0 16 16" aria-hidden="true">
                    ...
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="inputEmail4" type="text" name="ip_address"
                                value="{{ old('ip_address', $branch->ip_address) }}">
                            @error('ip_address')
                                <div class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                                    <svg class="h-5 w-5 text-danger" width="16" height="16" fill="currentColor"
                                        viewBox="0 0 16 16" aria-hidden="true">
                    ...
                    <div class="md:col-span-12 col-span-12">
                        ...
                        <div class="relative">
                            <textarea class="sm:p-5 py-3 px-4 ti-form-input" rows="2" name="description">{{ old('description', $branch->description) }}</textarea>
                        </div>
                        @error('description')
                            <p class="text-sm text-red-600 mt-2" id="hs-validation-name-error-helper">
                                <i>*{{ $message }}</i>

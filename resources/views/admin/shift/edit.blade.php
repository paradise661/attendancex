...
@section('content')
    <div class="xl:col-span-6 col-span-12 mt-4">
        <div class="box">
            ...
            <div class="box-body">
                <form class="grid grid-cols-12 gap-4 mt-0" action="{{ route('shifts.update', $shift->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="md:col-span-12 col-span-12">
                        ...
                        <div class="relative">
                            <input
                                ...
                                type="text" aria-label="Shift Name" name="name"
                        ...
                        <div class="relative">
                            <select
                                ...
                                @foreach ($departments as $department)
                                    <option {{ $department->id == $shift->department_id ? 'selected' : '' }}

...
@section('content')
    <div class="xl:col-span-6 col-span-12 mt-4">
        <div class="box">
            ...
            <div class="box-body">
                <form class="grid grid-cols-12 gap-4 mt-0" action="{{ route('publicholidays.update', $publicholiday->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="md:col-span-12 col-span-12">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    type="text" aria-label="Holiday Name" name="name"
                        ...
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    readonly="readonly" value="{{ old('start_date', $publicholiday->start_date) }}">
                                @error('start_date')
                                    <p class="text-sm text-red-600 mt-2"><i>*{{ $message }}</i></p>
                                @enderror
                            </div>
                        ...
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    readonly="readonly" value="{{ old('end_date', $publicholiday->end_date) }}">
                                @error('end_date')
                                    <p class="text-sm text-red-600 mt-2"><i>*{{ $message }}</i></p>
                                @enderror
                            </div>
                        ...
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <div class="relative">
                                <select
                                    ...
                                    name="gender">
                                    <option {{ old('gender', $publicholiday->gender) == 'Both' ? 'selected' : '' }}
                                        value="Both">Both</option>
                                    <option {{ old('gender', $publicholiday->gender) == 'Male' ? 'selected' : '' }}
                                        value="Male">Male</option>
                                    <option {{ old('gender', $publicholiday->gender) == 'Female' ? 'selected' : '' }}
                                        value="Female">Female
                                    </option>
                                </select>
                                @error('gender')
                            ...
                            @foreach ($departments as $department)
                                <div class="flex items-center space-x-2">
                                    <input class="form-checkbox ti-form-checkbox text-primary" type="checkbox"
                                        ...
                                        {{ in_array($department->id, old('departments', $publicholiday->departments()->pluck('department_id')->toArray())) ? 'checked' : '' }}>
